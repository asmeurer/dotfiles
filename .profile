...
export PS1='\[\e[1;38;2;128;128;128m\]$( [[ "${CONDA_DEFAULT_ENV}" == "base" ]] || printf "%s" ${CONDA_DEFAULT_ENV} )\[\e[1;38;2;255;255;255m\]\W\[\e[1;38;2;0;255;255m\]$(__git_ps1 "%s")\[\e[1;38;2;255;85;85m\]\$\[\e[0m\]\[$(set_tab_color)\]'
