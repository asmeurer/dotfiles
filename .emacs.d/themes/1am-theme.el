...
(custom-theme-set-faces
 ...
 '(diff-header ((t (:extend t :background "grey85" :foreground "black"))))
 '(diff-refine-added ((t (:inherit diff-refine-changed :background "brightgreen" :foreground "black"))))
 '(diff-refine-changed ((t (:background "midnightblue"))))
 '(diff-refine-removed ((t (:inherit diff-refine-changed :background "red"))))
